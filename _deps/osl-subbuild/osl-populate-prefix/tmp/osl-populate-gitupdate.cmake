...
execute_process(
  COMMAND "/bin/git" --git-dir=.git show-ref "master"
  WORKING_DIRECTORY "/home/kng/cppProjects/google_edu/TextParser/_deps/osl-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/kng/cppProjects/google_edu/TextParser/_deps/osl-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/kng/cppProjects/google_edu/TextParser/_deps/osl-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
